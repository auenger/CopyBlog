...
//                                  '<span class="arrow icon iconfont icon-112leftarrowhead" id="prevMonth"></span>'+
                                    '<span class="arrow fa fa-angle-double-left" id="prevYear" ></span> '+
                                    '<span class="arrow fa fa-angle-left" id="prevMonth"></span>'+
                                '</div>'+
...
//                                  '<span class="arrow icon iconfont icon-115rightarrowheads" id="nextYear"></span>'+
                                    '<span class="arrow fa fa-angle-right" id="nextMonth"></span> '+
                                    '<span class="arrow fa fa-angle-double-right" id="nextYear"></span>'+
                                '</div>'+
                            '</div>'
